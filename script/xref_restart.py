...
# In[1]:
## This script is a helper that would re-start to downloading the xref if the process got shut down prematurely. 
## This function reads the log file and find out where it ended and start from there.
