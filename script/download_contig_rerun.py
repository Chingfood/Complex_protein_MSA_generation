...
## This is the helper script that restart the contig downloading process if the process got shutdown pre-maturely. 

## This process depends on if some of the processes finished before other processes. If no process finished, then it would not help. For example: if contig download have 40 processes, 10 finished, 30 not, this script will restart those 30 processes.
